<!-- Changelog v2:
- Fixed opening hook: lead with the problem, pose a question
- Expanded acronyms on first use: UBI, LLM, CLI, TUI
- Removed backticks from inline text (kept code blocks)
- Merged duplicate "what we learned" sections
- Added hero image placeholder
- Added architecture Mermaid diagram
- Expanded build pipeline Mermaid diagram
- Added Job vs Deployment comparison diagram
- Added real CLI output snippets
- Added Red Hat/OpenShift AI link in CTA
- Varied bold-header structure in lessons section
-->
